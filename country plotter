...
# Imports all  files in the countries directory
import os 

from simpleimage import SimpleImage

# Dimensions of the final visualization.
VISUALIZATION_WIDTH = 1920
VISUALIZATION_HEIGHT = 1080

# Sets the 'boundaries' for the visualization. By default, the 
# visualization holds the entire world. Zoom into corresponding latitudes and longitudes 
...
def plot_pixel(visualization, x, y):
    ...
    Does not return anything in this function because the Pixel is 
    'mutated' in place
